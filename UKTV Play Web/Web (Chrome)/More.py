...
streaminglink = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[4]/a')
print(streaminglink.get_attribute('href'))
deviceslink = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[5]/a')
print(deviceslink.get_attribute('href'))
twitterlink1 = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[6]/a')
print(twitterlink1.get_attribute('href'))
twitterlink2 = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[7]/a[1]')
print(twitterlink2.get_attribute('href'))
helpdesklink = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[7]/a[2]')
print(helpdesklink.get_attribute('href'))
twitterlink3 = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[20]/a[1]')
print(twitterlink3.get_attribute('href'))
helpdesklink2 = driver.find_element(By.XPATH, '//*[@id="main-content"]/section/div/div/p[20]/a[2]')
