...
# Register Form
email = driver.find_element(By.ID, 'emailAddress').send_keys('operauser@testaccount.com')
...
time.sleep(5)
RegisterationComplete_Continuebutton = driver.find_element(By.CLASS_NAME'submit-button').click()
