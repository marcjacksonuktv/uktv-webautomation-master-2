...
time.sleep(2)
yesterdaydropdown = driver.find_element(By.ID, 'nav-bar-yesterday')
...
# --- scroll page ---
yesterdaytvguide = driver.find_element(By.ID, 'tv-guide').click()
time.sleep(2)
...
time.sleep(2)
Watchliveyesterday = driver.find_element(By.ID, 'on-now').click()
